...
def config():
    ...
    parser.add_argument('--data_split', type=str, default='pre')

    parser.add_argument('--gpu_id', type=int, default=0)
    parser.add_argument('--worker_id', type=int, default=0)
    parser.add_argument('--score_method', type=int, default=0)
    ...
    parser.add_argument('--coherence_type', type=str, default='null')
    ...
    parser.add_argument('--causal_token_finding', type=str, default='causal')
